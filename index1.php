...
<head>
    ...
    <link href="https://fonts.googleapis.com/css?family=IBM+Plex+Sans:wght@400;500;600;700&display=swap"
        rel="stylesheet">
...
<!-- <nav class="navbar navbar-expand-lg navbar-dark fixed-top">
        <div class="container">
            <a class="navbar-brand" href="index.php">
                <h4><i class="fa fa-user-plus"></i> KMC Hospital</h4>
            </a>
                    ...
                    <div class="card-body">
                        <form class="form-group" method="POST" action="func.php">
                            ...
                            <div class="text-center mt-4">
                                <button type="submit" name="patsub" id="inputbtn"
