...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap CSS removed (pages use local CSS/Tailwind) -->
    <link rel="stylesheet" href="css/bootstrap-compat.css">
  </head>
  <body style="background: linear-gradient(135deg, #10b981 0%, #6ee7b7 100%);color:white;text-align:center;padding-top:50px;">
