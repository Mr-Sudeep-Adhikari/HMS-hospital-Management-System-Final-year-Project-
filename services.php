...
<head>
    ...
    <title>Services | KMC Hospitall - KMC Hospital</title>
    ...
    <style>
        ...
        .card:hover {
            ...
            box-shadow: 0 50px 100px rgba(5, 150, 105, 0.5);
            border-color: #10b981;
        }
        ...
        .btn:hover {
            ...
            box-shadow: 0 40px 80px rgba(5, 150, 105, 0.7);
        }
...
<body class="gradient-bg min-h-screen text-white">
    ...
    <nav class="bg-emerald-800/95 backdrop-blur-xl fixed w-full top-0 z-50 shadow-2xl">
        <div class="max-w-7xl mx-auto px-6 py-5 flex justify-between items-center">
            <div class="flex items-center gap-4">
                ...
                <h1 class="text-4xl font-extrabold tracking-wider">KMC Hospitall</h1>
            </div>
            <div class="flex gap-8 text-lg font-medium">
                ...
                <a href="patientlogin.php"
                    class="bg-white text-emerald-700 px-8 py-3 rounded-full font-bold hover:bg-emerald-100 transition">Patient
                    Login</a>
            </div>
        </div>
    </nav>
    ...
    <section class="pt-32 pb-20 px-6 text-center">
        <div class="max-w-6xl mx-auto">
            ...
            <p class="text-2xl md:text-4xl text-emerald-100 max-w-5xl mx-auto">
                Advanced healthcare solutions at <strong>KMC Hospitall</strong> — powered by KMC Hospital
            </p>
        </div>
    </section>
    ...
    <section class="py-20 px-6 bg-white/10 backdrop-blur-lg">
        <div class="max-w-7xl mx-auto">
            <h2 class="text-5xl md:text-7xl font-extrabold text-center mb-20">Healthcare Services at KMC Hospitall</h2>
            <div class="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-12">
                <?php while ($s = mysqli_fetch_assoc($services)): ?>
                    <div class="card p-10 rounded-3xl shadow-2xl text-center group">
                        <div
                            class="w-28 h-28 bg-emerald-100 rounded-full flex items-center justify-center mx-auto mb-8 group-hover:scale-110 transition">
    ...
    <section class="py-20 px-6 bg-white/10 backdrop-blur-lg">
        <div class="max-w-5xl mx-auto text-center">
            <h2 class="text-6xl md:text-8xl font-extrabold mb-10">Welcome to KMC Hospitall</h2>
            <p class="text-3xl text-emerald-100 mb-12">Your Health. Our Priority. Always.</p>
            <a href="patientlogin.php"
                class="btn text-white font-extrabold text-3xl px-32 py-8 rounded-3xl shadow-2xl transition transform hover:scale-110 inline-block">
    ...
    <footer class="bg-emerald-900/90 py-16 text-center">
        <div class="max-w-7xl mx-auto px-6">
            <h1 class="text-6xl font-extrabold mb-4">KMC Hospitall</h1>
            <p class="text-2xl opacity-90 mb-4">Kathmandu, Nepal</p>
            <p class="text-emerald-200 text-lg">
                Powered by <strong>KMC Hospital</strong> • UI: <strong>Emerald Pulse</strong><br>
                © 2025 KMC Hospitall • All Rights Reserved
            </p>
        </div>
    </footer>
</body>
